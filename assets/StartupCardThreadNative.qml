                ...
                onTriggered: {
                    ...
                    if(replyAction.title == qsTr("Quote")) {
                        if(nextPageAction.title == qsTr("Cancel")) {
                            ...
                            pageContainer.gotoSingleQuoteMessage(pageThread.listItemSelected);
                        }
                    ...
                    if(replyAction.title == qsTr("Edit")) {
                        pageContainer.gotoEditMessage(showThreadController.getEditUrl(parseInt(pageThread.listItemSelected)));
                        pageContainer.closeContextMenu();
                    }
            ...
            ActionItem {
                ...
                onTriggered: {
                    ...
                    if(lastPageAction.title == qsTr("Profile")) {
                        if(!pageThread.profilePage)
                            pageThread.profilePage = profile.createObject();
                        
                        pageThread.profilePage.profileUrl = showThreadController.getProfileUrl(parseInt(pageThread.listItemSelected))
                        nav.push(pageThread.profilePage);
                        pageContainer.closeContextMenu();
                    }
            ...
            ActionItem {
                ...
                onTriggered: {
                    ...
                    if(surveyAction.title == qsTr("Delete post")) {
                        pageContainer.deletePost(pageThread.listItemSelected, showThreadController.getMessageAuthor(parseInt(pageThread.listItemSelected)));
                        pageContainer.closeContextMenu();
                    }
            ...
            ActionItem {
                ...
                onTriggered: {
                    ...
                    if(prevPageAction.title == qsTr("Favorite")) {
                        pageContainer.openContextActionPage(pageThread.listItemSelected);
                        pageContainer.closeContextMenu();
                    }
            ...
            ActionItem {
                ...
                onTriggered: {
                    ...
                    if(nextPageAction.title == qsTr("PM")) {
                        pageContainer.sendPrivateMessage(showThreadController.getMessageAuthor(parseInt(pageThread.listItemSelected)));
                        pageContainer.closeContextMenu();
                    }
